 ...
 */
public class EditorToolsFragment2 extends Fragment implements OnClickListener, OnLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_editor_tools2, container, false);
    }
    ...
    private EditorTools getToolForView(int viewId) {
        switch (viewId) {
            case R.id.editor_tools_marker2:
                return EditorTools.MARKER;

            case R.id.editor_tools_draw2:
                return EditorTools.DRAW;

            case R.id.editor_tools_poly2:
                return EditorTools.POLY;

            case R.id.editor_tools_trash2:
    ...
    private int getViewForTool(EditorTools tool) {
        switch (tool) {
            case MARKER:
                return R.id.editor_tools_marker2;

            case DRAW:
                return R.id.editor_tools_draw2;

            case POLY:
                return R.id.editor_tools_poly2;

            case TRASH:
                return R.id.editor_tools_trash2;

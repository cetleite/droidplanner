 ...
 */
public class EditorToolsFragment3 extends Fragment implements OnClickListener, OnLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_editor_tools3, container, false);
    }
    ...
    private EditorTools getToolForView(int viewId) {
        switch (viewId) {
            case R.id.editor_tools_marker3:
                return EditorTools.MARKER;

            case R.id.editor_tools_draw3:
                return EditorTools.DRAW;

            case R.id.editor_tools_poly3:
                return EditorTools.POLY;

            case R.id.editor_tools_trash3:
    ...
    private int getViewForTool(EditorTools tool) {
        switch (tool) {
            case MARKER:
                return R.id.editor_tools_marker3;

            case DRAW:
                return R.id.editor_tools_draw3;

            case POLY:
                return R.id.editor_tools_poly3;

            case TRASH:
                return R.id.editor_tools_trash3;
